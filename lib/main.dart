...
void main() {
  ...
  CaptainAmerica captainAmerica = CaptainAmerica(name: 'Chris Evans', heroName: 'Captain America', physicalAttack: 200);
  captainAmerica.introduce();
